        ...
        <div className="lg:flex lg:gap-10 items-start">
          <div className='lg:max-w-7/12'>
            <Heading
              ...
              Description={
                'Percorra um caminho inédito para entender o antagonismo entre feminismo e cristianismo. Além de conteúdos sobre política, fé e tudo o que for entrando de novo na plataforma para ampliar seu conhecimento e fortalecer seus princípios.'
              }
            />
          ...
          <img src={benefitsIMG} alt="Cristiane Correa" className='w-full lg:w-fit shadow-[0px_357px_100px_0px_rgba(0,0,0,0.00),0px_228px_91px_0px_rgba(0,0,0,0.04),0px_128px_77px_0px_rgba(0,0,0,0.13),0px_57px_57px_0px_rgba(0,0,0,0.21),0px_14px_31px_0px_rgba(0,0,0,0.25)]' />
        </div>
      </section>
