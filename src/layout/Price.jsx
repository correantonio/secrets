...
const Price = () => {
  ...
  return (
    <article className="bg-[url(./assets/05-Price/price-bg-img.jpg)] bg-no-repeat bg-top">
      <section className="container grid mx-auto py-20 px-6 lg:flex lg:gap-10 items-center justify-center">
                ...
                <div>
                  <Text>
                    ...
                    <b className="font-display text-grayish-10">
                      ...
                      {item.title} <ArrowRight className='inline mr-2 ml-2' width={16} height={16}/>
                    </b>
                    {item.description}
                  </Text>
                </div>
        ...
        <div className="bg-darkus-20 py-16 px-8 mt-32 mb-8 text-center grid gap-10 lg:max-w-5/12 lg:my-16 lg:order-2 shadow-[0px_357px_100px_0px_rgba(0,0,0,0.00),0px_228px_91px_0px_rgba(0,0,0,0.04),0px_128px_77px_0px_rgba(0,0,0,0.13),0px_57px_57px_0px_rgba(0,0,0,0.21),0px_14px_31px_0px_rgba(0,0,0,0.25)]">
          <div>
          ...
          <div className='grid gap-8 place-items-center'>
            <Button link={"https://chk.eduzz.com/D0RAB42B9Y"}>Quero fazer parte do Secrets</Button>
            <Payments/>
          </div>
        </div>
      </section>
